          ...
          axios({
            ...
            .then((response) => {
              ...
              if (mes == "Whoops! email yang Anda masukkan telah terdaftar") {
                ...
                mes == "Whoops! kontak yang Anda masukkan telah terdaftar"
              ) {
                Alert.alert(
                  "Gagal!",
                  "Kontak yang Anda masukkan telah terdaftar."
                );
                console.log("gagal2");
                setSubmitting(false);
              } else if (
                mes != "Whoops! kontak yang Anda masukkan telah terdaftar" &&
                mes != "Whoops! email yang Anda masukkan telah terdaftar"
              ) {
                Alert.alert("Register", "Anda berhasil registrasi!", [
                  {
                    text: "OK",
                    ...
                    <View style={styles.form}>
                      ...
                      <TextInput
                        ...
                        onChangeText={(kontak_darurat) =>
                          setKontakDarurat(kontak_darurat)
                        }
